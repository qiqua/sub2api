<template>
  ...
  >
    ...
    <div class="sidebar-header" :class="{ 'sidebar-header-collapsed': sidebarCollapsed }">
      ...
      >
        <img v-if="settingsLoaded" :src="siteLogo || '/xiaoming-logo.svg'" alt="Logo" class="h-full w-full object-contain" />
      </router-link>
...
//
// 条目顺序：工作台 → 密钥 → 用量 → 可用渠道 → 渠道状态 → 订阅/支付 → 兑换/资料。
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/usage-stats', label: t('nav.usageStats'), icon: ChartIcon, hideInSimpleMode: true },
    { path: '/leaderboard', label: t('nav.leaderboard'), icon: UsersIcon, hideInSimpleMode: true },
    { path: '/available-channels', label: t('nav.availableChannels'), icon: ChannelIcon, hideInSimpleMode: true, featureFlag: flagAvailableChannels },
    { path: '/route-settings', label: t('nav.routeSettings'), icon: ChannelIcon, hideInSimpleMode: true },
    ...
    { path: '/recharge-center', label: t('nav.rechargeCenter'), icon: CreditCardIcon, hideInSimpleMode: true, featureFlag: flagPayment },
