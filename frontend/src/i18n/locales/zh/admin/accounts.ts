export default {
    accounts: {
      ...
      upstreamBilling: {
        ...
        apiKeyQuotaLimited: 'API Key 额度：剩余 {remaining}（已用 {used} / 总额 {limit}）',
        apiKeyQuotaUnlimited: 'API Key 额度：不限额，已用 {used}',
        userBalance: '用户余额：{value}',
        rateLimitWindow: '{window} 窗口：剩余 {remaining}（已用 {used} / 总额 {limit}），重置 {reset}',
