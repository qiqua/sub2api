export default {
  ...
  keys: {
    ...
    autoRouting: {
      title: '多分组负载均衡',
      description: '开启后，此 API Key 会以主分组为锚点，在同平台候选分组中自动选择当前最空闲、可用账号最多的分组。用户调用时仍然只使用这一把 Key。',
      candidateHint: '请选择同平台候选分组；主分组会自动参与候选，不需要重复勾选。',
      noCandidates: '当前主分组没有可选的同平台候选分组',
      groupRequired: '开启多分组负载均衡后，请至少选择一个候选分组',
      selectedHint: '已选择 {count} 个候选分组，实际会在 {total} 个分组之间自动负载均衡。',
      badge: '自动 {count} 组',
      badgeTitle: '此 API Key 已开启多分组自动路由'
    },
    usage: '用量',
    today: '今日',
    total: '近30天',
  ...
  usage: {
    ...
    requestLog: {
      ...
      selected: '已选{count}',
      title: '请求记录',
      range: '显示第 {start}-{end} 条，共 {total} 条',
      requestId: '请求 ID',
      method: '方法',
      status: '状态',
      attempts: '尝试',
