export default {
    settings: {
      ...
      scheduling: {
        ...
        openaiFirstOutput: {
          title: 'OpenAI first-output / stream timeout',
          description: 'These values are stored in the database and take effect immediately after save. 0 disables the limit.',
          firstOutputTimeout: 'Normal request first-output budget (seconds)',
          firstOutputTimeoutHint: 'Total budget before the first semantic output. 0 disables it; suggested 20-25.',
          highEffortFirstOutputTimeout: 'High-effort first-output budget (seconds)',
          highEffortFirstOutputTimeoutHint: 'high / xhigh / max requests get a longer budget. 0 follows the normal budget; suggested 30-45.',
          failoverEnabled: 'Auto switch on first-output timeout',
          failoverEnabledHint: 'When enabled, a first-output timeout switches to another account and retries the current request only.',
          initialAttemptTimeout: 'First account wait budget (seconds)',
          initialAttemptTimeoutHint: 'Upper bound for the first account before the first semantic output. 0 uses the total budget; suggested 8-10.',
          maxSwitches: 'Max account switches',
          maxSwitchesHint: 'Maximum number of account switches before the first output. 0 disables switching; suggested 1.',
          penalizeAccount: 'Penalize slow accounts',
          penalizeAccountHint: 'Off by default: only switch accounts, do not penalize them. When enabled, slow accounts can be throttled or isolated.',
          streamDataIntervalTimeout: 'SSE silence timeout (seconds)',
          streamDataIntervalTimeoutHint: 'Maximum silence between SSE events while streaming. 0 disables it; suggested 60.',
        },
