export default {
    accounts: {
      ...
      upstreamBilling: {
        ...
        apiKeyQuotaLimited: 'API key quota: {remaining} remaining ({used}/{limit})',
        apiKeyQuotaUnlimited: 'API key quota: unlimited, used {used}',
        userBalance: 'User balance: {value}',
        rateLimitWindow: '{window} window: {remaining} remaining ({used}/{limit}), resets {reset}',
