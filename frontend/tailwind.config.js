  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        card: '0 1px 2px rgba(15, 23, 42, 0.06), 0 10px 30px -24px rgba(15, 23, 42, 0.45)',
        'card-hover': '0 16px 40px -24px rgba(15, 23, 42, 0.42)',
      ...
      keyframes: {
        ...
        glow: {
          ...
          '100%': { boxShadow: '0 0 30px rgba(37, 99, 235, 0.35)' }
        }
      },
      backdropBlur: {
        xs: '2px'
