...
// AutoRouteGroupIdsIsNil applies the IsNil predicate on the "auto_route_group_ids" field.
func AutoRouteGroupIdsIsNil() predicate.APIKey {
	return predicate.APIKey(sql.FieldIsNull(FieldAutoRouteGroupIds))
}

// AutoRouteGroupIdsNotNil applies the NotNil predicate on the "auto_route_group_ids" field.
func AutoRouteGroupIdsNotNil() predicate.APIKey {
	return predicate.APIKey(sql.FieldNotNull(FieldAutoRouteGroupIds))
}
