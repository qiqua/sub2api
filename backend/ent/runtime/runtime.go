...
func init() {
	...
	// apikeyDescAutoRouteGroupIds is the schema descriptor for auto_route_group_ids field.
	apikeyDescAutoRouteGroupIds := apikeyFields[5].Descriptor()
	// apikey.DefaultAutoRouteGroupIds holds the default value on creation for the auto_route_group_ids field.
	apikey.DefaultAutoRouteGroupIds = apikeyDescAutoRouteGroupIds.Default.([]int64)
