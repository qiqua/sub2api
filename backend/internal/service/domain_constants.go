...
const (
	...
	// OpenAI first-output / stream runtime knobs. These mirror gateway env/yaml
	// names, but DB values take precedence after the admin settings page saves.
	...
	SettingKeyOpenAIFirstOutputFailoverEnabled              = "openai_first_output_failover_enabled"
	SettingKeyOpenAIFirstOutputInitialAttemptTimeoutSeconds = "openai_first_output_initial_attempt_timeout_seconds"
	SettingKeyOpenAIFirstOutputMaxSwitches                  = "openai_first_output_max_switches"
	SettingKeyOpenAIFirstOutputPenalizeAccount              = "openai_first_output_penalize_account"
	SettingKeyStreamDataIntervalTimeout                     = "stream_data_interval_timeout"
