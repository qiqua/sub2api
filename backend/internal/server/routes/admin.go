...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/health-check-jobs", h.Admin.Account.CreateHealthCheckJob)
		accounts.GET("/health-check-jobs/:job_id", h.Admin.Account.GetHealthCheckJob)
		accounts.GET("/health-check-jobs/:job_id/results", h.Admin.Account.ListHealthCheckJobResults)
		accounts.POST("/health-check-jobs/:job_id/cancel", h.Admin.Account.CancelHealthCheckJob)
