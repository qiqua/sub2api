...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		OpenAIFirstOutputFailoverEnabled:                       settings.OpenAIFirstOutputFailoverEnabled,
		OpenAIFirstOutputInitialAttemptTimeoutSeconds:          settings.OpenAIFirstOutputInitialAttemptTimeoutSeconds,
		OpenAIFirstOutputMaxSwitches:                           settings.OpenAIFirstOutputMaxSwitches,
		OpenAIFirstOutputPenalizeAccount:                       settings.OpenAIFirstOutputPenalizeAccount,
